...
const ContactsModel: Schema = new Schema({
    firstName: { 
        type: String,
        required: false,
    },
...
const GroupModel: Schema = new Schema({
    name: {
        type: String,
        trim: true,
        required: true,
...
let contactModel = model('contact', ContactsModel);
let groupModel = model('Group', GroupModel);
